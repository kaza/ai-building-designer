...
| 2026-08-06 | Feedback #001: Win2 (pos 0, w 3.35) + Win7 (w 2.0) run to the W7/W6 corner = corner glazing, glass meets glass (no yellow post); Win3 (pos 3.35, w 1.9) abuts Win2 — no mullion | owner's first F-key feedback: "remove these two fragments of the wall, the windows should touch" — strokes auto-tagged W6+W7 |
| 2026-08-06 | Feedback #003/#005: D8 (pos 0, w 0.95) + D9 (w 0.55) head 2.80, edge-to-edge — the whole master north wall is glass; glazing runs through both joints (Room 2 west wall corner, W8 end cap → touches Win4, itself extended to pos 0 w 2.15) | owner: "door goes to the ceiling, same height as the window, the whole wall is glass" |
| 2026-08-06 | Feedback #004 + photo #29: deck windscreen on the west edge — "Deck Screen Stone" (0,8)–(0,10.5) `stone_rubble` + "Deck Screen Glass" (0,10.5)–(0,14) new `glass` finish; h 1.25 (≈1.1 above deck), t 0.12; tags W17/W18 appended | maquette shows stone near the house, glass panel running to the pool; height defaulted (owner gave the look, not a number) |
| 2026-08-06 | Door handles are FRAMEWORK geometry (IfcDiscreteAccessory per leaf face: swing = lever at latch, sliding/glass = vertical pull, NOTDEFINED = none — garage door skipped) | owner: doors "not only a brown blob", and "why is that not a framework feature" — it is now; renderer just maps "Handle" → metal |
